...
def yoi_figure(
    ...
    yoi_df = yoi_df.copy()
    z = (yoi_df["Scenario"] == slr_scenario) & (yoi_df["Threshold"] == threshold)
    ...
    z = (yoi_df["10-year multiplier"] < 0) | yoi_df["10-year multiplier"].isna()
    yoi_df.loc[z, "10-year multiplier"] = 0

    mltplr_txt = ["≥10X" if m == 10 else str(m) for m in yoi_df["10-year multiplier"]]
    ...
    fig = px.scatter(
        ...
        color_discrete_sequence=[
            # '#e69f00','#56b4e9','#009e74','#cc79a7','#0071b2','#d55e00','#f0e442'
            # '#0077bb','#33bbee','#009988','#bbbbbb','#cc3311','#ee3377','#ee7733'
            "#228833", "#66ccee", "#4477aa", "#bbbbbb", "#ee6677", "#aa3377", "#ccbb44"
        ],
        #         color_discrete_sequence=[
        ...
        fig.add_trace(
            go.Scatter(
                ...
                marker=dict(
                    ...
                    sizemode="area",
                    sizeref=2.0 * max(size_legend["10-year multiplier"]) / (29.0 ** 2),
                    sizemin=0,
