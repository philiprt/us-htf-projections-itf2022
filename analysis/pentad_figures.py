...
def pentad_figures(analysis, subset, yr_lims):
    ...
    fig = psb.make_subplots(
        rows=2, cols=2, vertical_spacing=vspace, horizontal_spacing=hspace,
    )
    ...
    fig.update_layout(
        ...
        template="none",
        shapes=shapes,
        margin=dict(l=25, r=70, b=30, t=70, pad=0,),
        hovermode="closest",
