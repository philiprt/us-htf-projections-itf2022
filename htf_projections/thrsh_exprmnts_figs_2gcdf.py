...
def main():
    ...
    for idx, sta in stations.iterrows():
        ...
        print(str(idx) + ": " + sta["name"] + " (" + str(sta["id"]) + ")")
        ...
        thrsh_exprmnts_figs(sta, trace, rt, x_nrm, tru, x, y, show_or_save="save")
...
def thrsh_exprmnts_figs(
    ...
    ax.fill_between(e99_tru, N_xd_ci05, N_xd_ci95, color=col[1], alpha=0.5, lw=0)
    ax.fill_between(
